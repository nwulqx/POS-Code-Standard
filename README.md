...
| 文档 | 适用项目 | 特点 | 阅读时长 |
|------|---------|------|----------|
| [DRS_WECOM_POS_STANDARD.md](./DRS_WECOM_POS_STANDARD.md) | **仅** drs-wecom-pos（企业微信小程序） | Taro/POS-UI/Figma 规范 | 8 分钟 |

> ⚠️ **重要提示**：
> - 如果你开发的是 `drs-wecom-pos` 项目，必须同时遵守**通用规范 + 项目特定规范**
> - 如果是其他 POS 项目，**只需遵守通用规范**即可，不要被项目特定规范干扰
> - 项目特定规范包含 Figma 像素转换、POS-UI 组件清单等仅适用于特定项目的规则
